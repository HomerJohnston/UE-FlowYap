...
class FGameplayTagFilteredStyleSet final : public FSlateStyleSet
{
public:
	...
	FGameplayTagFilteredStyleSet(const FName& InStyleSetName)
...
TSharedPtr<FSlateStyleSet> FGameplayTagFilteredStyle::StyleSet = nullptr;


void FGameplayTagFilteredStyle::Initialize()
{
	if (StyleSet.IsValid())
	{
		return;
	...
	StyleSet = MakeShared<FGameplayTagFilteredStyleSet>(GetStyleSetName());
	
	FSlateStyleRegistry::RegisterSlateStyle(*StyleSet.Get());
}

void FGameplayTagFilteredStyle::Shutdown()
{
	if (StyleSet.IsValid())
	{
...
FName FGameplayTagFilteredStyle::GetStyleSetName()
{
	static FName StyleName("GameplayTagFilteredStyle");
	return StyleName;
}
