...
#include "YapEditor/NodeWidgets/GameplayTagFilteredEditorUtilities.h"
...
void SGameplayTagComboFiltered::Construct(const FArguments& InArgs)
{
	...
	auto* Image = FYapEditorStyle::GetImageBrush(YapBrushes.Icon_Tag);
...
FText SGameplayTagComboFiltered::GetText() const
{
	...
	return FText::FromString(YapUtil::GetFilteredSubTag(Filter, TagAttribute.Get()));
}
